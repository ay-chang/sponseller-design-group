            ...
            <div className="flex flex-col sm:flex-row gap-12 sm:gap-16 mb-16 items-center">
                ...
                <div className="w-full sm:w-1/2">
                    ...
                    <p className="text-sm sm:text-md leading-relaxed pb-6 sm:pb-8">
                        ...
                        Robert M. Sponseller FAIA, and Jennifer Chen AIA. Two colleagues that
                        have been working together for over 15 years in a previous office in
                        Washington DC.
                    </p>
                    <p className="text-sm sm:text-md leading-relaxed">
                        Robert Sponseller FAIA worked as lead design principal on some of the
                        most significant sites in Washington DC and surrounding areas. Jennifer
                        Chen is a design team leader guiding the development and realization of
